                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                @php
                                    ...
                                    for ($month = 1; $month <= $atualMonth; $month++) {
                                        $CountDateUsers[] = $users->filter(fn($user) =>
                                                $user->role === 'user' &&
                                                $user->created_at->month === $month
                                        )->count();
                                    }
                                ...
                                <div class="col-5">
                                    <h5 class="mb-0 text-end">{{$CountDateUsers[0]}}</h5>
                                </div>
                                <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                @php
                                    ...
                                    for ($month = 1; $month <= $atualMonth; $month++) {
                                        $CountDateAdmins[] = $users->filter(fn($user) =>
                                                $user->role === 'admin' &&
                                                $user->created_at->month === $month
                                        )->count();
                                    }
                                ...
                                <script>
                                 ...
                                 <div class="col-5"> 
                                        <h5 class="mb-0 text-end">{{$CountDateAdmins[0]}}</h5>
                                </div>
                                <div class="col-12">
                                ...
                                <table class="table table-hover table-lg">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="http://localhost:8000/profile">editar</a>
                                            </td>
                                            <td>
                                                <a href="http://localhost:8000/realdash">excluir</a>
                                            </td>
                                        </tr>
